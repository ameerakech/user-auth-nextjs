...
//           <span className='text-red-600 text-sm'>This month</span> <br></br>Best Selling Features</h2>
//         </div>
...
//             <img src={product.image} alt={product.name} className="w-60 h-48 ml-28  mb-2" />
//             <div className="text-gray-600"></div>
//             <h3 className="text-lg font-semibold ml-18">{product.name}</h3>
//             <div className="text-green-600 ml-15">
//               ${product.price}
//             </div>
//             <div className="flex items-center justify-center mt-2 ml-13">
